...
public class CustomPolicyProviderFactory implements PolicyProviderFactory<CustomPolicyRepresentation> {
    ...
    public PolicyProvider create(AuthorizationProvider authorizationProvider) {
        log.infof("A %s is being created", CustomPolicyProvider.class.getSimpleName());
        return provider;
    }

    @Override
    public CustomPolicyRepresentation toRepresentation(Policy policy, AuthorizationProvider authorization) {
        log.infof("A %s is being represented", CustomPolicyRepresentation.class.getSimpleName());
